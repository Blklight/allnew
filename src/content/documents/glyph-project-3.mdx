...
description: "Um projeto pessoal para explorar e organizar informações sobre o universo de Mass Effect, com um design futurista inspirado na estética do jogo."
cover: "https://ultimatemercer.com/images/glyph.png"
documentType: "project"
date: "2025-03-12 15:14"
tags:
  - mass effect
  - futurismo
  - universo sci-fi
...
✅ **Busca Avançada** → Filtragem por categorias e palavras-chave.  
...
✔ Adicionar uma seção de ilustrações e conceitos visuais.  
✔ Expandir a base de dados com mais informações do universo Mass Effect.  
✔ Criar um **modo interativo**, com uma IA simulando um assistente da Normandia.

---

## 🌌 **Conclusão**

O **Glyph** é um projeto em constante evolução, criado com paixão por **Mass Effect** e pelo design futurista. Ele busca ser mais do que um simples banco de dados, mas sim uma **experiência interativa** para fãs da franquia.
