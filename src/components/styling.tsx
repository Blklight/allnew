...
import { articleData } from "./dev-tools";
...
export default function CardSelector() {
  const [selectedLayout, setSelectedLayout] = useState("background");
    ...
    <div className="w-full mx-auto grid gap-4">
      ...
      <div className="w-full">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="background">Card com Background</SelectItem>
            <SelectItem value="vertical">Card Vertical</SelectItem>
            <SelectItem value="simple">Card simples</SelectItem>
          </SelectContent>
        </Select>
      </div>

      <div className="w-full">
        {selectedLayout === "background" && (
          <BackgroundCard
            data={articleData.doc}
        ...
        {selectedLayout === "vertical" && (
          <ArticleCard
            data={articleData.doc}
            authors={articleData.authordetails}
          />
        )}
